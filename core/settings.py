...
# 1. Build paths (Defined once at the top)
...
# If DATABASE_URL is set in the environment (like on Vercel), use it instead of SQLite
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Or whatever your templates path is
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
